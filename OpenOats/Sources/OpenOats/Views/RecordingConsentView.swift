...
struct RecordingConsentView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            Text("""
            \(KortexOatsIdentity.appDisplayName) records and transcribes audio from your microphone \
            ...
            VStack(alignment: .leading, spacing: 8) {
                ...
                consentBullet("The developers of \(KortexOatsIdentity.appDisplayName) accept no liability for unauthorized or unlawful recording.")
            }
